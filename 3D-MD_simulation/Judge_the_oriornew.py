...
def main(mat_file_path_Color_cen, Colorcen_file_path,
         mat_file_path_3_Coor, mat_file_path_4_Coor,
         Coor3_xyz_file_path, Coor4_xyz_file_path,
         Coor3_xyz_ori_output_file_path, Coor4_xyz_ori_output_file_path,
         Coor3_xyz_output_file_path, Coor4_xyz_output_file_path):
    ...
    # use for 0.2 W
    mat_file_path_Color_cen = f'{mat_file_path_Color_cen}'
    Colorcen_file_path = f'{Colorcen_file_path}'
    ...
    # use for 0.2 W
    mat_file_path_3_Coor = f'{mat_file_path_3_Coor}'
    # print(f" 4 Coordination XYZ File: {args._4_Coor_xyz_file_path}")
    mat_file_path_4_Coor = f'{mat_file_path_4_Coor}'
    ...
    # ----------------------------------------------------------------------------------------
    # use for 0.2 W
    _3_Coor_xyz_file_path = f'{Coor3_xyz_file_path}'
    _4_Coor_xyz_file_path = f'{Coor4_xyz_file_path}'

    _3_Coor_xyz_ori_output_file_path = f'{Coor3_xyz_ori_output_file_path}'
    _4_Coor_xyz_ori_output_file_path = f'{Coor4_xyz_ori_output_file_path}'
    Others_Coor_xyz_ori_output_file_path = f'./file_0.2 W/file_others_Coordination_ori_output.xyz'

    _3_Coor_xyz_output_file_path = f'{Coor3_xyz_output_file_path}'
    _4_Coor_xyz_output_file_path = f'{Coor4_xyz_output_file_path}'
